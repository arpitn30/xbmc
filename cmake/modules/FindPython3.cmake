...
if(PKG_CONFIG_FOUND)
  pkg_check_modules(PC_PYTHON3 python>=3 QUIET)
endif()
...
find_path(PYTHON3_INCLUDE_DIR NAMES Python.h PATHS ${PC_PYTHON3_INCLUDE_DIRS} ${DEPENDS_PATH}/${ARCH}/include/python3.6)
