...
if(KODI_DEPENDSBUILD)
  ...
  set(PYTHON_INCLUDE_DIR ${PYTHON2_INCLUDE_DIR})
  find_package(PythonLibs 2.7 REQUIRED)
  unset(PYTHON_INCLUDE_DIR)
  set(PYTHON2_LIBRARY ${PYTHON_LIBRARY})
  set(PYTHON2_LIBRARIES ${PYTHON_LIBRARIES} ${PC_PYTHON_STATIC_LIBRARIES})
endif()

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(Python2 REQUIRED_VARS PYTHON2_INCLUDE_DIR PYTHON2_LIBRARY PYTHON2_LIBRARIES)
if(PYTHON2_FOUND)
